    ...
    <div>
      ...
      <div className="flex flex-col h-[80vh] md:h-[60vh] lg:h-[100vh] lg:mx-20 mx-2 child:my-10">
        ...
        <div>
          ...
          <m.p className="font-abhaya lg:text-6xl text-5xl font-extrabold text-transparent text-stroke2 lg:text-stroke lg:ml-20 " variants={appear} initial="initial" whileInView="animate" viewport={{ once: false, amont: 0.3 }}>Design</m.p>
